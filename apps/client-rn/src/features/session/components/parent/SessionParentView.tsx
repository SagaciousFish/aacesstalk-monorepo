...
export const SessionParentView = (props: {
    ...
    return <Fragment>
        ...
        <MultiTapButton numberOfTaps={5} onTapGesture={onTapSecretButton}><View className="absolute top-0 left-0 w-60 h-60 bg-transparent" /></MultiTapButton>
